...
namespace OrderSystem
{
    internal class StartUpCommand : SimpleCommand
    {
        public override void Execute(INotification notification)
        {
            ...
            Facade.RegisterProxy(houseProxy);
            ...
            Facade.RegisterMediator(new HouseMediator(mainUI.HouseView));

            Facade.RegisterCommand(OrderSystemCommed.GUEST_BE_AWAY,typeof(GuestBeAwayCommed));
            Facade.RegisterCommand(OrderSystemCommed.GET_ORDER,typeof(GetAndExitOrderCommed));
            Facade.RegisterCommand(OrderSystemCommed.CookCooking, typeof(CookCommend));
            Facade.RegisterCommand(OrderSystemCommed.selectWaiter, typeof(WaiterCommend));
        }
    }
}